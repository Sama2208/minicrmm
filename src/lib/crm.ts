                                          ...
                                          konsultatsiyaga_keldi: "Konsultatsiyaga keldi",
                                            yotishga_yozildi: "Yotishga yozildi",
                                              bekor_qilindi: "Bekor qilindi",
                                                qayta_qongiroq_2: "Qayta qo'ng'iroq 2",
                                                  qayta_qongiroq_4: "Qayta qo'ng'iroq 4",
                                                    qayta_qongiroq_6_sifatsiz: "Qayta qo'ng'iroq 6 sifatsiz",
                                                    };

                                                    export const STATUS_BADGE: Record<LeadStatus, string> = {
                                                      yangi: "bg-blue-50 text-blue-700 border border-blue-200",
                                                        qayta_qongiroq: "bg-orange-50 text-orange-700 border border-orange-200",
                                                          sifatsiz: "bg-rose-50 text-rose-700 border border-rose-200",
                                                                    ...
                                                                    konsultatsiyaga_keldi: "bg-emerald-50 text-emerald-700 border border-emerald-200",
                                                                      yotishga_yozildi: "bg-amber-50 text-amber-700 border border-amber-200",
                                                                        bekor_qilindi: "bg-slate-100 text-slate-600 border border-slate-200",
                                                                          qayta_qongiroq_2: "bg-orange-50 text-orange-700 border border-orange-200",
                                                                            qayta_qongiroq_4: "bg-orange-100 text-orange-800 border border-orange-300",
                                                                              qayta_qongiroq_6_sifatsiz: "bg-rose-100 text-rose-800 border border-rose-300",
                                                                              };
