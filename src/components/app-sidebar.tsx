...
import { Users, BarChart3, Settings, LogOut, CalendarDays, UserCog, HeartPulse, Stethoscope, Wallet, FlaskConical } from "lucide-react";
...
const ITEMS = [
  ...
  { title: "Shifokorlar", url: "/shifokorlar", icon: Stethoscope },
  { title: "Qabul jadvali", url: "/kalendar", icon: CalendarDays },
  { title: "Moliya", url: "/moliya", icon: Wallet },
  { title: "Klinika", url: "/klinika", icon: FlaskConical },
